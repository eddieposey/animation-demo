class Toggle extends HTMLElement {
    constructor(){
        ...
        const lightAttribute = this.getAttribute("light") === "true" ? "army-toggle-light" : "";
        const template = document.createElement("template");
        if (!idAttribute) {
            console.log("please check your markup. the toggle component is missing an id attribute");
            return;
        }
        template.innerHTML = `
      <style>
    ...
    `;
        ...
        this.addEventListener("click", ()=>{
            ...
            this.dispatchEvent(new CustomEvent("selected-language", {
                detail: {
